...
HIDDEN_SIZE = int(environ.get("OMEGA_HIDDEN_SIZE", 1024))
...
NUMBER_OF_ATTENTION_LAYERS = int(environ.get("OMEGA_NUMBER_OF_ATTENTION_LAYERS", 20))
...
THOUGHT_SIZE = int(environ.get("OMEGA_THOUGHT_SIZE", 4096))

THOUGHT_RANK_SIZE = int(environ.get("OMEGA_THOUGHT_RANK_SIZE", 2048))
