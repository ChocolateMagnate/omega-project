...
# convenience. The default value is bigcode/starcoderdata because it provides mix of code and English
# documentation, and for extending it into other languages, it should be changed. The number of chunks
# to train on is configured with OMEGA_HUGGINGFACE_CHUNKS.
OMEGA_HUGGINGFACE_DATASET = environ.get("OMEGA_HUGGINGFACE_DATASET", "bigcode/starcoderdata")
